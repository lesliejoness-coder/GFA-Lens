  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full opacity-10" style={{ background: "radial-gradient(circle, #60a5fa, transparent)" }} />
        <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full opacity-10" style={{ background: "radial-gradient(circle, #a78bfa, transparent)" }} />
      </div>
      ...
      <div className="w-full max-w-md px-6 relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">AFGBank GFA</h1>
          <p className="text-blue-200 text-sm mt-1">Plateforme de gestion et supervision</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="admin@afgbank.cm" required
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <button type="button" className="text-xs text-blue-600">Mot de passe oublié ?</button>
              </div>
              <div className="relative">
                <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-center text-blue-300 text-xs mt-6">© 2025 AFGBank — Tous droits réservés</p>
      </div>
    </div>
  );
}
