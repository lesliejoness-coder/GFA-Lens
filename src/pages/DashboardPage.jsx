...
const ALL_INCIDENTS = [
  {
    id: 1,
    titre: "Connexion impossible à GFA",
  ...
  {
    id: 4,
    titre: "Module rapport inaccessible",
            ...
            <thead className="bg-gray-50 text-gray-500 uppercase text-[10px] font-bold">
              <tr>
                {["Agence", "Filiale", "Statut", "Disponibilité"].map((h) => (
                  <th
                    key={h}
                    className="text-left py-3 px-4 text-xs font-semibold text-gray-500 uppercase whitespace-nowrap"
                  >
                    {h}
                  </th>
                ))}
              ...
              {agences.map((a, i) => (
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    <span
                      className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${a.statut === "Active" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
                    >
                      {a.statut}
                    </span>
                  </td>
          ...
          {filtered.length === 0 ? (
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  {["Titre", "Agence", "Priorité", "Statut", "Date"].map(
                    (h) => (
                      <th
                        key={h}
